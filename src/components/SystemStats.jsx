function SystemStats({ stats, pendingCount, providersCount, adminRequestsCount }) {
  const getStatusBreakdown = () => {
    ...
    return [
      { label: 'Pending', value: statusData.pending || 0, color: '#fbbf24' },
      { label: 'Assigned', value: statusData.assigned || 0, color: '#3b82f6' },
      { label: 'Paid', value: statusData.paid || 0, color: '#10b981' },
      { label: 'Completed', value: statusData.completed || 0, color: '#6b7280' }
    ]
  }
  ...
  const getUserBreakdown = () => {
    ...
    return [
      { label: 'Patients', value: userData.patient || 0, color: '#667eea' },
      { label: 'Providers', value: userData.provider || 0, color: '#11998e' },
      { label: 'Admins', value: userData.admin || 0, color: '#ff6b6b' }
    ]
  }
